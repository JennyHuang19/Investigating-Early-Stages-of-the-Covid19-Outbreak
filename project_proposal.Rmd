...
ggplot(covid_condprob, mapping = aes(x = age_group, fill = death)) + 
  ...
  labs(y = "", x = "Age Group", fill = "Survival Status", title =
...
Ulitmately, a patient's gender, whether they visited Wuhan recently, whehter 
they live in Wuhan, and what country they are from doesn't seem to affect the 
