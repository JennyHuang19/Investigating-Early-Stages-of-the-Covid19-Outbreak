...
There were several missing values present among each of the variables of 
interest. Given that we filtered out these "NA" values before creating the 
logistic model, we have to consider that the incompleteness of the data we 
are working with makes our model is less valid and representative of the true 
scenario.
